...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public synchronized void onResume() {
    ...
    mp1 = MediaPlayer.create(this, R.raw.hundred);
    mp2 = MediaPlayer.create(this, R.raw.fivehun);
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 8) {
      ...
      if (recognition != null) {
        ...
        try {
         if (!fivehun&&recognitionTextView.getText().toString().equalsIgnoreCase("500")&& confi>90 ) {
            mp2.start();
            fivehun = true;
           hundred=false;
            ten = false;
          }else if (!hundred&&recognitionTextView.getText().toString().equalsIgnoreCase("100")&& confi>90 ) {
            mp1.start();
            fivehun = false;
            hundred=true;
            ten = false;
